...
<html>
    ...
    <head>
		...
		{block css}
			{cssmin "slate-frontend.css"}
			<link href='http://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic|Arvo:400,400italic' rel='stylesheet' type='text/css'>
		{/block}
	...
	<body class="{block 'body-class'}{str_replace('/', '_', $.responseId)}-tpl{/block}">
		...
		<div class="main-ct">
			<div class="main wrapper clearfix">
				...
				<aside class="sidebar">
					...
					{block sidebar}
						{include designs/site.sidebar.tpl}
					{/block}
				</aside>
		...
		<div class="footer-ct">
			<footer class="wrapper clearfix">
				{block footer}
					<div class="footer-primary">{include designs/site.footer.tpl}</div>
    	...
    	{block "js-bottom"}
        	{include designs/site.js-bottom.tpl}
    	{/block}
    
    	{block "js-analytics"}
    		{include designs/site.analytics.tpl}
    	{/block}
