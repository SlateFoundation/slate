...
{block 'body'}
	...
	{foreach item=Record from=$data}
		...
		{if $Record.Class == 'Slate\\Progress\\Note'}{progressnote $Record}
		{*elseif $Record.Class == 'Slate\\Progress\\Narratives\\Report'}{narrative $Record}
		{elseif $Record.Class == 'Slate\\Progress\\Interims\\Report'}{interim $Record}
		{elseif $Record.Class == 'Standards'}{standards $Record*}
		{/if}
