...
//        },
        {
            ...
            dataIndex: 'Assignee',
            xtype: 'templatecolumn',
            tpl: '<tpl if="Assignee">{[console.log(values)]}<tpl if="AssigneeClass == &quot;Person&quot;">{Assignee.FirstName} {Assignee.LastName}<tpl elseif="AssigneeClass == &quot;Group&quot;">{Assignee.Name}</tpl></tpl>'
        },{
            text: 'Status',
            dataIndex: 'Status',
            flex: 1,
