...
//    listeners: {
//        beforecellclick: function (sender, td, cellIndex, record, tr, rowIndex, e, eOpts) {
//            var clickedColIndex = null;
//            
//            if (cellIndex === 0 && !Ext.fly(e.target).hasCls('x-grid-row-checker')) {                
//                console.log('not grid row checker');
//                return false;
//            }
//            
//            console.log(clickedColIndex, 'clicked col index');
//            clickedColIndex = cellIndex;
//            
//        },
//        beforedeselect: function (rowmodel, record, index, eOpts) {
//           var clickedColIndex = clickedColIndex || -1;
//           console.log(clickedColIndex, 'clickedColIndex');
...
//    },
    ...
    selModel: {
        pruneRemoved: false,
        checkSelector: 'td:has(.'+Ext.baseCSSPrefix+'grid-row-checker)'
    },
