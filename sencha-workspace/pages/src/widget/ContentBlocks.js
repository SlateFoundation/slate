...
//        debugger;
        //create hints
        hints.push(Ext.DomHelper.createDom('<p class="hint hint-markdown">Use <a href="http://daringfireball.net/projects/markdown/basics" target=_blank>Markdown</a> for formatting.<br>You can drag an image into this area to upload and generate a code for it.</p>'));
